...
router.post(`/`, async(req,res)=>{
    ...
    const orderItemsIdsResolver = await orderItemsIds;

    const totalPrices = await Promise.all(orderItemsIdsResolver.map(async(orderItemsId)=>{
...
router.delete(`/:id`, (req,res)=>{
    ...
    Order.findByIdAndRemove(req.params.id).then(async (user) =>{
        if(order){
